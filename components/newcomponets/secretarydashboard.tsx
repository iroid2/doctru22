...
import { Bell, Search, Eye, CheckCircle, XCircle, Clock, FileText, User } from 'lucide-react'
...
export default function UnderSecretaryDashboard() {
  const [requisitions, setRequisitions] = useState<Requisition[]>([
    {
      ...
      timeline: [
        ...
        { date: '2023-09-16', action: 'Under Review', user: 'System' },
      ]
    },
    {
      id: '2',
      ...
      status: 'Pending',
      timeline: [
        { date: '2023-09-14', action: 'Submitted', user: 'Jane Smith' },
        { date: '2023-09-15', action: 'Under Review', user: 'System' },
      ]
    },
  ])
